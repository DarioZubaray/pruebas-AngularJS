...
describe('MedicosComponent', () => {
    ...
    it('Debe de agregar un nuevo medico al arreglo de medicos', () => {
        ...
        const medico = { id: 1, nombre: 'Dario' };
        const espia = spyOn(servicio, 'agregarMedico').and.returnValue( from( [medico] ) );
    ...
    it('Debe de llamar al servidor para borrar medico', () => {

        spyOn( window, 'confirm').and.returnValue(true);
        const espia = spyOn(servicio, 'borrarMedico').and.callFake( (medico: any) => {
            return empty();
        });
    ...
    it('No Debe de llamar al servidor para borrar medico', () => {
